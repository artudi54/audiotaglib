...
namespace tag::priv::config {
    ...
    static const std::string PREFERRED_ID3V2_ENCODING   = "WriteConfiguration.PreferredID3v2Encoding"s;
    ...
    static const EnumStringTranslator<tag::config::ID3v2APEv2Option > ID3V2_APEV2_OPTION_TRANSLATOR({
        ...
        {tag::config::ID3v2APEv2Option::ID3v2, "APEv2"s}
    });
    ...
    static const EnumStringTranslator<tag::config::PreferredID3v2Encoding> PREFERRED_ID3V2_ENCODING_TRANSLATOR({
        {tag::config::PreferredID3v2Encoding::Latin1,   "Latin1"s},
        {tag::config::PreferredID3v2Encoding::Utf16BOM, "Utf16BOM"s},
        {tag::config::PreferredID3v2Encoding::Utf16BE,  "Utf16BE"s},
        {tag::config::PreferredID3v2Encoding::Utf8,     "Utf8"s}
    });
    ...
    static const EnumStringTranslator<tag::config::WaveTagFormat > WAVE_TAG_FORMAT_TRANSLATOR({
        ...
        {tag::config::WaveTagFormat::ID3Chunk,      "ID3Chunk"s},
    ...
    void fillPropertyTree(boost::property_tree::ptree &propertyTree,
        ...
        propertyTree.add(PREFERRED_ID3V2_ENCODING,   writeConfiguration.preferredID3v2Encoding, PREFERRED_ID3V2_ENCODING_TRANSLATOR);
    ...
    tag::config::WriteConfiguration getWriteConfigFromPropertyTree(const boost::property_tree::ptree &propertyTree) {
        ...
        writeConfiguration.preferredID3v2Encoding = propertyTree.get<tag::config::PreferredID3v2Encoding>(
                PREFERRED_ID3V2_ENCODING, writeConfiguration.preferredID3v2Encoding, PREFERRED_ID3V2_ENCODING_TRANSLATOR);
